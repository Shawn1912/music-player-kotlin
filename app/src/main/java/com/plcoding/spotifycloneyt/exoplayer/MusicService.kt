...
class MusicService: MediaBrowserServiceCompat() {
    ...
    override fun onCreate() {
        ...
        // called everytime the player chooses a new song
    ...
    override fun onDestroy() {
        ...
        exoPlayer.removeListener(musicPlayerEventListener) // to prevent memory leaks
        exoPlayer.release() // to release player
    }
